...
def obtener_palabra(palabras):
    # Seleccionar palabra al azar en la lista de palabras validas
...
def ahorcado():
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        #Mostrar el estado actual de las letreas
        ...
        #Si la letra escogida por el usuario esta en el abecedario y no esta en el conjunto de letras que ya se han ingresado, se mete la letra al conjunto de letras ingresadas.
        if letra_usuario in abecedario - letras_adivinadas:
            letras_adivinadas.add(letra_usuario)
            
            #Esta la letra en la palabra?
            #Si esta en la palabra se quita esta letra de las letras por adivinar
        ...
        #Si la letra escogida por el usuario ya fue ingresada
            ...
            print("\nYTa escogiste esa letra. Por favor escoge una letra nueva.")
        else:
